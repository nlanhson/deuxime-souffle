...
| 3 | **Hero: next session** — EHPAD, address + distance, time, status chip, **Démarrer** + Itinéraire | The #1 field action: get there, check in | `C21`/`C22`/`C23` view assigned/details/status · **`C16` Check-in** · persona "check in on site" |
