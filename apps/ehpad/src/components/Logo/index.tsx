...
// La couleur de la tuile reprend le picto officiel du site (deuxieme-souffle.com) : noir d'encre sur
// fond clair, blanc sur fond sombre — d'où le défaut `--color-text-primary`, qui suit déjà le thème.
// Le chemin unique (viewBox 0 0 188.99 188.99).
const LOGO_PATH =
